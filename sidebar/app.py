...
st.sidebar.write('**당신이 선택**: ', your_option)
...
image_files = [
    'https://github.com/seoyoung1024/streamlit/blob/main/sidebar/data/Vermeer.png?raw=true',
    'https://github.com/seoyoung1024/streamlit/blob/main/sidebar/data/Gogh.png?raw=true',
    'https://github.com/seoyoung1024/streamlit/blob/main/sidebar/data/Munch.png?raw=true',
    'https://github.com/seoyoung1024/streamlit/blob/main/sidebar/data/ShinYoonBok.png?raw=true'
]
